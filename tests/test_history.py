...
class MinuteAggregationTestCase(WithBcolzMinutes,
                                ZiplineTestCase):
    ...
    def init_class_fixtures(cls):
        super(MinuteAggregationTestCase, cls).init_class_fixtures()

        cls.EQUITY1 = cls.env.asset_finder.retrieve_asset(1)
        cls.EQUITY2 = cls.env.asset_finder.retrieve_asset(2)

    def init_instance_fixtures(self):
        super(MinuteAggregationTestCase, self).init_instance_fixtures()
